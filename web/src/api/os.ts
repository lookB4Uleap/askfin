...
import { getEndpoint } from '@/lib/auth'
...
export const getAgentsAPI = async (
  ...
  const endpoint = (await getEndpoint()) as string
...
export const getStatusAPI = async (authToken?: string): Promise<number> => {
  const endpoint = (await getEndpoint()) as string
  const response = await fetch(APIRoutes.Status(endpoint), {
    method: 'GET',
    headers: createHeaders(authToken)
  })
...
export const getAllSessionsAPI = async (
  ...
  try {
    const endpoint = (await getEndpoint()) as string
    const url = new URL(APIRoutes.GetSessions(endpoint))
...
export const getSessionAPI = async (
  ...
  const response = await fetch(
    `${APIRoutes.GetSession(endpoint, sessionId)}?${queryParams.toString()}`,
    {
      method: 'GET',
      headers: createHeaders(authToken)
    }
...
export const deleteSessionAPI = async (
  ...
  const response = await fetch(
    `${APIRoutes.DeleteSession(endpoint, sessionId)}?${queryParams.toString()}`,
    {
      method: 'DELETE',
      headers: createHeaders(authToken)
    }
...
export const deleteTeamSessionAPI = async (
  ...
  const endpoint = (await getEndpoint()) as string
  const response = await fetch(
    APIRoutes.DeleteTeamSession(endpoint, teamId, sessionId),
    {
      method: 'DELETE',
      headers: createHeaders(authToken)
    }
